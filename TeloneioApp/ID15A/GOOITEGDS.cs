...
namespace TeloneioApp.ID15A
{
    public class GOOITEGDS : INotifyPropertyChanged
    {
        ...
        private Models.ID15A.COMCODGODITM _comcodgoditm;
        private List<Models.ID15A.CALTAXGOD> _caltaxgod;
        private List<Models.ID15A.CONNR2> _connr2;
        ...
        public Models.ID15A.COMCODGODITM COMCODGODITM
        {
        ...
        public List<Models.ID15A.CALTAXGOD> CALTAXGOD
        {
        ...
        [XmlElement("CONNR2")]
        public List<Models.ID15A.CONNR2> CONNR2
        {
            get { return _connr2; }
            set { _connr2 = value; }
        }
