...
namespace TeloneioApp.Models
{
    public class ImportFormModel : INotifyPropertyChanged
    {
        ...
        public ImportFormModel(ID15A.ID15A modelId15A)
        {
        ...
        private ID15A.ID15A XmlObjectId15A { get; set; }
        ...
        public int DatOfPreMES9
        {
            ...
            set { XmlObjectId15A.DatOfPreMES9 = value; RefreshXmlString(); }
        }

        public int TimOfPreMES10
        {
            get { return XmlObjectId15A.TimOfPreMES10; }
            set { XmlObjectId15A.TimOfPreMES10 = value; RefreshXmlString(); }
        }

        public int TesIndMES18
        {
            get { return XmlObjectId15A.TesIndMES18; }
            set { XmlObjectId15A.TesIndMES18 = value; RefreshXmlString(); }
        }

        public long MesIdeMES19
        {
            get { return XmlObjectId15A.MesIdeMES19; }
            set { XmlObjectId15A.MesIdeMES19 = value; RefreshXmlString(); }
        }

        public string MesTypMES20
        {
            get { return XmlObjectId15A.MesTypMES20; }
            set { XmlObjectId15A.MesTypMES20 = value; RefreshXmlString(); }
        }

        public HEAHEA Head
        {
            get { return XmlObjectId15A.Head; }
            set { XmlObjectId15A.Head = value; RefreshXmlString(); }
        }

        public TRACONCO1 TRACONCO1
        {
            get { return XmlObjectId15A.TRACONCO1; }
            set { XmlObjectId15A.TRACONCO1 = value; RefreshXmlString(); }
        }

        public TRACONCE1 TRACONCE1
        {
            get { return XmlObjectId15A.TRACONCE1; }
            set { XmlObjectId15A.TRACONCE1 = value; RefreshXmlString(); }
        }

        public List<GOOITEGDS> GOOITEGDS
        {
            get { return XmlObjectId15A.GOOITEGDS; }
            set { XmlObjectId15A.GOOITEGDS = value; RefreshXmlString(); }
        }

        public DELTER DELTER
        {
            get { return XmlObjectId15A.DELTER; }
            set { XmlObjectId15A.DELTER = value; RefreshXmlString(); }
        }

        public TRADAT TRADAT
        {
            get { return XmlObjectId15A.TRADAT; }
            set { XmlObjectId15A.TRADAT = value; RefreshXmlString(); }
        }

        public TRAREP TRAREP
        {
            get { return XmlObjectId15A.TRAREP; }
            set { XmlObjectId15A.TRAREP = value; RefreshXmlString(); }
        }

        public STATREP385 STATREP385
        {
            get { return XmlObjectId15A.STATREP385; }
            set { XmlObjectId15A.STATREP385 = value; RefreshXmlString(); }
        }

        public ENTCUSOFF ENTCUSOFF
        {
            get { return XmlObjectId15A.ENTCUSOFF; }
            set { XmlObjectId15A.ENTCUSOFF = value; RefreshXmlString(); }
        }

        public IMPCUSOFF IMPCUSOFF
        {
            get { return XmlObjectId15A.IMPCUSOFF; }
            set { XmlObjectId15A.IMPCUSOFF = value; RefreshXmlString(); }
        }
